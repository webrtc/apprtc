...
def get_wss_parameters(request):
  ...
  # ViewAR: Replace https://helpar.viewar.com:3005 with https://localhost:3005 because otherwise it's inaccessible.
  if wss_tls and wss_tls == 'false':
    wss_url = 'ws://' + wss_host_port_pair + '/ws'

    wss_post_url = 'http://localhost:3005'
    # wss_post_url = 'http://' + wss_host_port_pair
  else:
    wss_url = 'wss://' + wss_host_port_pair + '/ws'
    
    wss_post_url = 'https://localhost:3005'
